...
export class AuthController {
  ...
  @ApiResponse({
    status: 401,
    description: 'Credenciales inválidas o colaborador suspendido.',
  })
  ...
  @ApiResponse({
    status: 401,
    description: 'Token de refresco inválido, expirado o ya revocado.',
  })
  @ApiResponse({ status: 500, description: 'Error interno del servidor.' })
  ...
  @ApiResponse({
    status: 403,
    description: 'La sesión no pertenece al colaborador autenticado.',
  })
